...
function invalidateBlogCategoryBlogTags(args?: { blogId?: string; blogCategoryId?: string }) {
  updateTag('blogs');
...
export async function createBlogCategoryBlogActionPrivate(
  input: CreateBlogCategoryBlogRequest,
): Promise<ActionResponse<BlogCategoryBlogResponse>> {
  const result = await executeApi(async () => createBlogCategoryBlogApiPrivate(input));
  if (result.success) {
...
export async function getBlogCategoryBlogsByBlogCategoryIdActionPublic(
  ...
  return executeApi(async () => getBlogCategoryBlogsByBlogCategoryIdApiPublic(blogCategoryId));
}

export async function getAllBlogCategoryBlogsActionPublic(): Promise<
  ActionResponse<BlogCategoryBlogResponse[]>
> {
  'use cache';
  cacheLife('default');
...
export async function updateBlogCategoryBlogActionPrivate(
  id: string,
  input: UpdateBlogCategoryBlogRequest,
): Promise<ActionResponse<BlogCategoryBlogResponse>> {
  const result = await executeApi(async () => updateBlogCategoryBlogApiPrivate(id, input));
  if (result.success) {
    invalidateBlogCategoryBlogTags();
  }
  return result;
...
export async function deleteBlogCategoryBlogsByBlogIdActionPrivate(
  ...
  const result = await executeApi(async () => deleteBlogCategoryBlogsByBlogIdApiPrivate(blogId));
  if (result.success) {
