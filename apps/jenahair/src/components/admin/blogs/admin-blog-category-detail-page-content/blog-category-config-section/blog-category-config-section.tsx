...
import classes from './blog-category-config-section.module.scss';

interface BlogCategoryConfigSectionProps {
...
export default function BlogCategoryConfigSection({
  form,
  availableSortOrders,
  isSaving,
  onSave,
  onExit,
  onDeleteClick,
}: BlogCategoryConfigSectionProps) {
  return (
    <Paper pt={0} p={'xs'} radius={'md'} classNames={{ root: classes.blogCategoryConfigSectionRoot }}>
      <Stack gap={'0'}>
