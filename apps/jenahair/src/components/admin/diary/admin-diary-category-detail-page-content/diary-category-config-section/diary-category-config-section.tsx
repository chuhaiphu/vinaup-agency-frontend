...
import classes from './diary-category-config-section.module.scss';

interface DiaryCategoryConfigSectionProps {
...
export default function DiaryCategoryConfigSection({
  form,
  availableSortOrders,
  isSaving,
  onSave,
  onExit,
  onDeleteClick,
}: DiaryCategoryConfigSectionProps) {
  return (
    <Paper pt={0} p={'xs'} radius={'md'} classNames={{ root: classes.diaryCategoryConfigSectionRoot }}>
      <Stack gap={'0'}>
        <Group justify="space-between" wrap="nowrap">
          ...
          <Select
            ...
            onChange={(value) => {
              if (!value) return;
              form.setFieldValue('sortOrder', parseInt(value));
            }}
          />
        </Group>
