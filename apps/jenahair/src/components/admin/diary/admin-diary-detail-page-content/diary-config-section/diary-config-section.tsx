...
import classes from './diary-config-section.module.scss';
...
interface DiaryConfigSectionProps {
...
export default function DiaryConfigSection({
  form,
  updatedAt,
  isSaving,
  onSave,
  onExit,
  onDeleteClick,
}: DiaryConfigSectionProps) {
  return (
    <Paper
      p={'xs'}
      radius={'md'}
      classNames={{
        root: classes.diaryConfigSectionRoot,
      }}
    >
      <Stack gap={'0'}>
