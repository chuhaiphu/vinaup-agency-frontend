...
import { updateCarouselActionPrivate } from '@/actions/theme-config-action';
...
interface AdminThemeBannerCarouselPageContentProps {
    carouselPromise: Promise<ActionResponse<ICarouselSlidesResponse>>;
}
...
export default function AdminThemeBannerCarouselPageContent({
    ...
    const initialSlides: ICarouselSlide[] = result.data?.value ?? [];

    return (
        <AdminThemeBannerCarouselPageContentInner initialSlides={initialSlides} />
    );
}
...
function AdminThemeBannerCarouselPageContentInner({
    ...
    const handleUpdateSlide = (
        id: string,
        field: keyof Omit<ICarouselSlide, 'id'>,
        value: string
    ) => {
        setSlides((prev) =>
