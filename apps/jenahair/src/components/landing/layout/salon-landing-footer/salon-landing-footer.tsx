...
export function SalonLandingFooter() {
  return (
    <Box component="footer" className={classes.footerWrapper}>
      <Container size={'xl'} px={{ base: 0, md: 'md' }} className={classes.footerContainer}>
              ...
              <div className={classes.contactBlock}>
                ...
                <div className={classes.contactInfo}>
                  ...
                  <Group gap="sm" className={classes.socialLinks}>
                    ...
                    <Anchor
                      href="https://m.me/1926675050924056"
                      target="_blank"
                      className={classes.socialLink}
                    >
                      Messenger
        ...
        <div className={classes.copyright}>
          <Text size="md" className={classes.copyrightText}>
            Jenahair © 2026 by{' '}
            <Anchor href="https://vinaup.net" target="_blank" rel="noopener noreferrer" size="">
              VinaUp
            </Anchor>
          </Text>
        </div>
