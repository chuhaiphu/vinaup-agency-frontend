...
import AdminDiaryDetailPageContentSkeleton from '@/components/admin/diary/admin-diary-detail-page-content/admin-diary-detail-page-content-skeleton';
...
export default function AdminDiaryDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Suspense fallback={<AdminDiaryDetailPageContentSkeleton />}>
