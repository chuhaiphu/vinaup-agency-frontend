      ...
      <Container size="xl">
        ...
        <Box className={classes.tagsWrapper}>
          <Group className={classes.tagGroup}>
            {tags.map((tag, index) => (
              <Button key={index} className={classes.tagButton} radius="md">
                {tag}
              </Button>
            ))}
          </Group>
          ...
          <GridCol span={{ base: 12, md: 5 }}>
            <div className={classes.logoWrapper}>
              ...
              <div className={classes.subLinks}>
                <Text component="a" href="https://vitinhnet.com" target="_blank">
                  vitinhnet.com
                </Text>
                <Text component="a" href="https://vitinhlugia.com" target="_blank">
                  Vitinhlugia.com
                </Text>
              </div>
            </div>
